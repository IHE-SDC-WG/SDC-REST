            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("1.0.0", new Info
                    {
                        ...
                        Description = "IHE Structured Data Capture API (ASP.NET Core 2.0)",
                        Contact = new Contact()
                        {
                    ...
                    c.DocumentFilter<BasePathFilter>("/IHE-SDC4/ihesdc0/1.0.0");
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            app
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/swagger/1.0.0/swagger.json", "IHE Structured Data Capture API");

                    //TODO: Or alternatively use the original Swagger contract that's included in the static files
                    // c.SwaggerEndpoint("/swagger-original.json", "IHE Structured Data Capture API Original");
                });
